...
checkBtn1.addEventListener('click', () => {
  ...
  console.log("li1의 부모 노드 : ", parent);

  // 요소.firstChild : 첫 번째 자식 노드 탐색
  // 요소.lastChild : 마지막 자식 노드 탐색
  console.log("첫 번째 자식 노드 : ", parent.firstChild);
  console.log("마지막 자식 노드 : ", parent.lastChild);
  ...
  // list[9] 다음, 다음 형제 노드 탐색
  console.log("list[9] 다음,다음 형제 노드 : ", list[9].nextSibling.nextSibling);  

  // list[5]의 이전, 이전 형제 노드 탐색
  console.log("list[5]의 이전, 이전 형제 노드 : ", list[5].previousSibling.previousSibling);
